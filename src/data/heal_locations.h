static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ECRUTEAK_CITY - 1] = {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY), 30, 38},
    [HEAL_LOCATION_OLIVINE_CITY - 1] = {MAP_GROUP(OLIVINE_CITY), MAP_NUM(OLIVINE_CITY), 15, 30},
    [HEAL_LOCATION_CIANWOOD_CITY - 1] = {MAP_GROUP(CIANWOOD_CITY), MAP_NUM(CIANWOOD_CITY), 34, 54},
    [HEAL_LOCATION_MAHOGANY_TOWN - 1] = {MAP_GROUP(MAHOGANY_TOWN), MAP_NUM(MAHOGANY_TOWN), 18, 22},
    [HEAL_LOCATION_BLACKTHORN_CITY - 1] = {MAP_GROUP(BLACKTHORN_CITY), MAP_NUM(BLACKTHORN_CITY), 27, 34},
    [HEAL_LOCATION_ROUTE28 - 1] = {MAP_GROUP(ROUTE28), MAP_NUM(ROUTE28), 29, 14},
};
