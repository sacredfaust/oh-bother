...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_PEWTER_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CERULEAN_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LAVENDER_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_VERMILION_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CELADON_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FUCHSIA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CINNABAR_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_INDIGO_PLATEAU] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SAFFRON_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_4_FLYDUP] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_10_FLYDUP] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_MT_MOON] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_S_S_ANNE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_UNDERGROUND_PATH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_UNDERGROUND_PATH_2] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DIGLETTS_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KANTO_VICTORY_ROAD] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROCKET_HIDEOUT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SILPH_CO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POKEMON_MANSION] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_KANTO_SAFARI_ZONE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POKEMON_LEAGUE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROCK_TUNNEL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SEAFOAM_ISLANDS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POKEMON_TOWER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CERULEAN_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_POWER_PLANT] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_AQUA_HIDEOUT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MAGMA_HIDEOUT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MIRAGE_TOWER] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BIRTH_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FARAWAY_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ARTISAN_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MARINE_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_UNDERWATER_MARINE_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TERRA_CAVE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_DESERT_UNDERPASS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ALTERING_CAVE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NAVEL_ROCK] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TRAINER_HILL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NEW_BARK_TOWN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CHERRYGROVE_CITY] = MAPPOPUP_THEME_MARBLE,
