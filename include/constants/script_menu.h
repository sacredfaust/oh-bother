...
#define SSTIDAL_SELECTION_VERMILION        2
#define SSTIDAL_SELECTION_LILYCOVE         2//FOR VERMILION
#define SSTIDAL_SELECTION_SEVII            3
#define SSTIDAL_SELECTION_SOUTHERN_ISLAND  4
#define SSTIDAL_SELECTION_NAVEL_ROCK       5
#define SSTIDAL_SELECTION_BIRTH_ISLAND     6
#define SSTIDAL_SELECTION_FARAWAY_ISLAND   7
#define SSTIDAL_SELECTION_EXIT             8
#define SSTIDAL_SELECTION_COUNT            9
...
#define SSTIDAL_SELECTION_BATTLE_FRONTIER_S  1
#define SSTIDAL_SELECTION_LILYCOVE_S         2
#define SSTIDAL_SELECTION_VERMILION_S        3
#define SSTIDAL_SELECTION_SEVII_S            4
#define SSTIDAL_SELECTION_SOUTHERN_ISLAND_S  5
#define SSTIDAL_SELECTION_NAVEL_ROCK_S       6
#define SSTIDAL_SELECTION_BIRTH_ISLAND_S     7
#define SSTIDAL_SELECTION_FARAWAY_ISLAND_S   8
#define SSTIDAL_SELECTION_EXIT_S             9
#define SSTIDAL_SELECTION_COUNT_S            10
